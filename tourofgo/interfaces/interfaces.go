...
func Interfaces() {
	...
	// print.PrintSection(interfaces10, "stringer interface")
	// print.PrintSection(interfaces11, "stringer interface exercise")
	// print.PrintSection(interfaces12, "error interface")
